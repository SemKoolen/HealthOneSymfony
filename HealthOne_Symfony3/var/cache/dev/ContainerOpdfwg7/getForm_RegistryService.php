...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Forms\\LoginType' => function () {
    return ${($_ = isset($this->services['AppBundle\Forms\LoginType']) ? $this->services['AppBundle\Forms\LoginType'] : $this->services['AppBundle\Forms\LoginType'] = new \AppBundle\Forms\LoginType()) && false ?: '_'};
